...
<template>
   <section class="w-full bg-[url('/house-banner.png')] bg-center bg-cover flex justify-center">
    <div class="container h-[35rem] flex justify-center items-center ">
      <div class="w-96 md:w-[50rem] ">
        <div class="w-80 md:w-[25rem] ">
          <h1 class=" text-4xl text-blue-800 h-full w-full rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 font-bold text-center mb-2  " >Find your next house</h1>
        </div>
        <Searchbar />
      </div>
    </div>
  ...
  <section class="max-w-6xl grid lg:grid-cols-2 gap-4 mx-4 xl:mx-auto mt-20">
    <div>
      ...
      <div class="flex items-center bg-blue-700 dark:bg-blue-800 p-8 rounded-lg">
        <div>
          <h3 class="text-2xl font-semibold text-white mb-5">We have houses listing on all states in Philippines!</h3>
        ...
        <img src="../../Assets/Images/philippines-map.svg" class="w-40" />
      </div>
